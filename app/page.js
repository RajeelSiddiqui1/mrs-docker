...
import { IconFolder, IconSearch, IconPlus, IconTrash, IconAlertTriangle } from "@tabler/icons-react";
...
export default function Home() {
  ...
  const fetchFolders = async () => {
    if (status !== "authenticated") return; // Skip fetching if not logged in
    setFetching(true);
    try {
        ...
        <div className="p-6 max-w-7xl mx-auto pt-24">
          {status === "unauthenticated" ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-gray-400 text-lg">Please log in to view or create folders</p>
            ...
            <>
              ...
              <p className="text-center text-neutral-400 mb-10 max-w-2xl mx-auto">
                Organize your files with ease. Create folders, upload your images, and access them from anywhere.
              </p>
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      disabled={status !== "authenticated"} // Disable button if not logged in
                    >
